# Book Store App
Interative Bookstore website built with ReactJS.
...
- Clone the repository by excecuting the git clone ```git@github.com:jrosario19/bookstore.git``` from the terminal.
- Execute the ```cd bookstore``` command to access the repository directory.
